...
#segmented churn with senior citizen, partner and dependents
WITH segment_churn AS (
...
SELECT 'PhoneService' AS service,
       SUM(CASE WHEN PhoneService_Flag=1 THEN 1 ELSE 0 END) AS total_customers_with_service,
       SUM(CASE WHEN PhoneService_Flag=1 AND Churn_Flag=1 THEN 1 ELSE 0 END) AS churned_customers,
       ROUND(
           SUM(CASE WHEN PhoneService_Flag=1 AND Churn_Flag=1 THEN 1 ELSE 0 END) * 100.0
           / NULLIF(SUM(CASE WHEN PhoneService_Flag=1 THEN 1 ELSE 0 END),0), 2
       ) AS churn_rate_percentage
FROM telecom_customers

UNION ALL
SELECT 'MultipleLines',
       SUM(CASE WHEN MultipleLines_Flag=1 THEN 1 ELSE 0 END),
       SUM(CASE WHEN MultipleLines_Flag=1 AND Churn_Flag=1 THEN 1 ELSE 0 END),
       ROUND(
           SUM(CASE WHEN MultipleLines_Flag=1 AND Churn_Flag=1 THEN 1 ELSE 0 END) * 100.0
           / NULLIF(SUM(CASE WHEN MultipleLines_Flag=1 THEN 1 ELSE 0 END),0), 2
       )
FROM telecom_customers

UNION ALL
SELECT 'OnlineSecurity',
       SUM(CASE WHEN OnlineSecurity_Flag=1 THEN 1 ELSE 0 END),
       SUM(CASE WHEN OnlineSecurity_Flag=1 AND Churn_Flag=1 THEN 1 ELSE 0 END),
       ROUND(
           SUM(CASE WHEN OnlineSecurity_Flag=1 AND Churn_Flag=1 THEN 1 ELSE 0 END) * 100.0
           / NULLIF(SUM(CASE WHEN OnlineSecurity_Flag=1 THEN 1 ELSE 0 END),0), 2
       )
FROM telecom_customers

UNION ALL
SELECT 'OnlineBackup',
       SUM(CASE WHEN OnlineBackup_Flag=1 THEN 1 ELSE 0 END),
       SUM(CASE WHEN OnlineBackup_Flag=1 AND Churn_Flag=1 THEN 1 ELSE 0 END),
       ROUND(
           SUM(CASE WHEN OnlineBackup_Flag=1 AND Churn_Flag=1 THEN 1 ELSE 0 END) * 100.0
           / NULLIF(SUM(CASE WHEN OnlineBackup_Flag=1 THEN 1 ELSE 0 END),0), 2
       )
FROM telecom_customers

UNION ALL
SELECT 'DeviceProtection',
       SUM(CASE WHEN DeviceProtection_Flag=1 THEN 1 ELSE 0 END),
       SUM(CASE WHEN DeviceProtection_Flag=1 AND Churn_Flag=1 THEN 1 ELSE 0 END),
       ROUND(
           SUM(CASE WHEN DeviceProtection_Flag=1 AND Churn_Flag=1 THEN 1 ELSE 0 END) * 100.0
           / NULLIF(SUM(CASE WHEN DeviceProtection_Flag=1 THEN 1 ELSE 0 END),0), 2
       )
FROM telecom_customers

UNION ALL
SELECT 'TechSupport',
       SUM(CASE WHEN TechSupport_Flag=1 THEN 1 ELSE 0 END),
       SUM(CASE WHEN TechSupport_Flag=1 AND Churn_Flag=1 THEN 1 ELSE 0 END),
       ROUND(
           SUM(CASE WHEN TechSupport_Flag=1 AND Churn_Flag=1 THEN 1 ELSE 0 END) * 100.0
           / NULLIF(SUM(CASE WHEN TechSupport_Flag=1 THEN 1 ELSE 0 END),0), 2
       )
FROM telecom_customers

UNION ALL
SELECT 'StreamingTV',
       SUM(CASE WHEN StreamingTV_Flag=1 THEN 1 ELSE 0 END),
       SUM(CASE WHEN StreamingTV_Flag=1 AND Churn_Flag=1 THEN 1 ELSE 0 END),
       ROUND(
           SUM(CASE WHEN StreamingTV_Flag=1 AND Churn_Flag=1 THEN 1 ELSE 0 END) * 100.0
           / NULLIF(SUM(CASE WHEN StreamingTV_Flag=1 THEN 1 ELSE 0 END),0), 2
       )
FROM telecom_customers

UNION ALL
SELECT 'StreamingMovies',
       SUM(CASE WHEN StreamingMovies_Flag=1 THEN 1 ELSE 0 END),
       SUM(CASE WHEN StreamingMovies_Flag=1 AND Churn_Flag=1 THEN 1 ELSE 0 END),
       ROUND(
           SUM(CASE WHEN StreamingMovies_Flag=1 AND Churn_Flag=1 THEN 1 ELSE 0 END) * 100.0
           / NULLIF(SUM(CASE WHEN StreamingMovies_Flag=1 THEN 1 ELSE 0 END),0), 2
       )
FROM telecom_customers;
